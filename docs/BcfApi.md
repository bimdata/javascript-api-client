...
> bcf21ProjectsDocumentsDelete(id, projectsPk)
...
apiInstance.bcf21ProjectsDocumentsDelete(id, projectsPk, callback);
```
...
> bcf21ProjectsDocumentsPartialUpdate(id, projectsPk, opts)
...
apiInstance.bcf21ProjectsDocumentsPartialUpdate(id, projectsPk, opts, callback);
```
...
> bcf21ProjectsDocumentsRead(id, projectsPk)
...
apiInstance.bcf21ProjectsDocumentsRead(id, projectsPk, callback);
```
...
> bcf21ProjectsDocumentsUpdate(id, projectsPk, opts)
...
apiInstance.bcf21ProjectsDocumentsUpdate(id, projectsPk, opts, callback);
```
...
> CommentEvent bcf21ProjectsTopicsCommentsEventsCreate_0(commentsPk, projectsPk, topicsPk, data)
...
apiInstance.bcf21ProjectsTopicsCommentsEventsCreate_0(commentsPk, projectsPk, topicsPk, data, callback);
```
...
> [CommentEvent] bcf21ProjectsTopicsCommentsEventsList_1(commentsPk, projectsPk, topicsPk, )
...
apiInstance.bcf21ProjectsTopicsCommentsEventsList_1(commentsPk, projectsPk, topicsPk, , callback);
```
...
> CommentEvent bcf21ProjectsTopicsCommentsEventsPartialUpdate_0(commentsPk, id, projectsPk, topicsPk, data)
...
apiInstance.bcf21ProjectsTopicsCommentsEventsPartialUpdate_0(commentsPk, id, projectsPk, topicsPk, data, callback);
```
...
> CommentEvent bcf21ProjectsTopicsCommentsEventsRead_0(commentsPk, id, projectsPk, topicsPk, )
...
apiInstance.bcf21ProjectsTopicsCommentsEventsRead_0(commentsPk, id, projectsPk, topicsPk, , callback);
```
...
> CommentEvent bcf21ProjectsTopicsCommentsEventsUpdate_0(commentsPk, id, projectsPk, topicsPk, data)
...
apiInstance.bcf21ProjectsTopicsCommentsEventsUpdate_0(commentsPk, id, projectsPk, topicsPk, data, callback);
```
...
> bcf21ProjectsTopicsDelete(id, projectsPk, )
...
apiInstance.bcf21ProjectsTopicsDelete(id, projectsPk, , callback);
```
...
> bcf21ProjectsTopicsEventsDelete(id, projectsPk, )
...
apiInstance.bcf21ProjectsTopicsEventsDelete(id, projectsPk, , callback);
```
...
> TopicEvents bcf21ProjectsTopicsEventsPartialUpdate(id, projectsPk, data)
...
apiInstance.bcf21ProjectsTopicsEventsPartialUpdate(id, projectsPk, data, callback);
```
...
> TopicEvents bcf21ProjectsTopicsEventsRead(id, projectsPk, )
...
apiInstance.bcf21ProjectsTopicsEventsRead(id, projectsPk, , callback);
```
...
> TopicEvents bcf21ProjectsTopicsEventsUpdate(id, projectsPk, data)
...
apiInstance.bcf21ProjectsTopicsEventsUpdate(id, projectsPk, data, callback);
```
...
> Topic bcf21ProjectsTopicsPartialUpdate(id, projectsPk, data)
...
apiInstance.bcf21ProjectsTopicsPartialUpdate(id, projectsPk, data, callback);
```
...
> Topic bcf21ProjectsTopicsRead(id, projectsPk, )
...
apiInstance.bcf21ProjectsTopicsRead(id, projectsPk, , callback);
```
...
> Topic bcf21ProjectsTopicsUpdate(id, projectsPk, data)
...
apiInstance.bcf21ProjectsTopicsUpdate(id, projectsPk, data, callback);
```
...
> Bitmap bcf21ProjectsTopicsViewpointsBitmapPartialUpdate(viewpointsPk, id, projectsPk, topicsPk, data)
...
apiInstance.bcf21ProjectsTopicsViewpointsBitmapPartialUpdate(viewpointsPk, id, projectsPk, topicsPk, data, callback);
```
...
> Bitmap bcf21ProjectsTopicsViewpointsBitmapRead(viewpointsPk, id, projectsPk, topicsPk, )
...
apiInstance.bcf21ProjectsTopicsViewpointsBitmapRead(viewpointsPk, id, projectsPk, topicsPk, , callback);
```
...
> Bitmap bcf21ProjectsTopicsViewpointsBitmapUpdate(viewpointsPk, id, projectsPk, topicsPk, data)
...
apiInstance.bcf21ProjectsTopicsViewpointsBitmapUpdate(viewpointsPk, id, projectsPk, topicsPk, data, callback);
```
...
> Coloring bcf21ProjectsTopicsViewpointsColoringPartialUpdate(viewpointsPk, id, projectsPk, topicsPk, data)
...
apiInstance.bcf21ProjectsTopicsViewpointsColoringPartialUpdate(viewpointsPk, id, projectsPk, topicsPk, data, callback);
```
...
> Coloring bcf21ProjectsTopicsViewpointsColoringRead(viewpointsPk, id, projectsPk, topicsPk, )
...
apiInstance.bcf21ProjectsTopicsViewpointsColoringRead(viewpointsPk, id, projectsPk, topicsPk, , callback);
```
...
> Coloring bcf21ProjectsTopicsViewpointsColoringUpdate(viewpointsPk, id, projectsPk, topicsPk, data)
...
apiInstance.bcf21ProjectsTopicsViewpointsColoringUpdate(viewpointsPk, id, projectsPk, topicsPk, data, callback);
```
...
> Component bcf21ProjectsTopicsViewpointsSelectionPartialUpdate(viewpointsPk, id, projectsPk, topicsPk, data)
...
apiInstance.bcf21ProjectsTopicsViewpointsSelectionPartialUpdate(viewpointsPk, id, projectsPk, topicsPk, data, callback);
```
...
> Component bcf21ProjectsTopicsViewpointsSelectionRead(viewpointsPk, id, projectsPk, topicsPk, )
...
apiInstance.bcf21ProjectsTopicsViewpointsSelectionRead(viewpointsPk, id, projectsPk, topicsPk, , callback);
```
...
> Component bcf21ProjectsTopicsViewpointsSelectionUpdate(viewpointsPk, id, projectsPk, topicsPk, data)
...
apiInstance.bcf21ProjectsTopicsViewpointsSelectionUpdate(viewpointsPk, id, projectsPk, topicsPk, data, callback);
```
...
> Visibility bcf21ProjectsTopicsViewpointsVisibilityPartialUpdate(viewpointsPk, id, projectsPk, topicsPk, data)
...
apiInstance.bcf21ProjectsTopicsViewpointsVisibilityPartialUpdate(viewpointsPk, id, projectsPk, topicsPk, data, callback);
```
...
> Visibility bcf21ProjectsTopicsViewpointsVisibilityRead(viewpointsPk, id, projectsPk, topicsPk, )
...
apiInstance.bcf21ProjectsTopicsViewpointsVisibilityRead(viewpointsPk, id, projectsPk, topicsPk, , callback);
```
...
> Visibility bcf21ProjectsTopicsViewpointsVisibilityUpdate(viewpointsPk, id, projectsPk, topicsPk, data)
...
apiInstance.bcf21ProjectsTopicsViewpointsVisibilityUpdate(viewpointsPk, id, projectsPk, topicsPk, data, callback);
```
