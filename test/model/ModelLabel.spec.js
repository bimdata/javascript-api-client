...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new bimdata.ModelLabel();
  });
  ...
  describe('ModelLabel', function() {
    it('should create an instance of ModelLabel', function() {
      // uncomment below and update the code to test ModelLabel
      //var instance = new bimdata.ModelLabel();
      //expect(instance).to.be.a(bimdata.ModelLabel);
    });
