...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new bimdata.PatchedTransformRequest();
  });
  ...
  describe('PatchedTransformRequest', function() {
    it('should create an instance of PatchedTransformRequest', function() {
      // uncomment below and update the code to test PatchedTransformRequest
      //var instance = new bimdata.PatchedTransformRequest();
      //expect(instance).to.be.a(bimdata.PatchedTransformRequest);
    });
