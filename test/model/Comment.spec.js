...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BimdataApiClient.Comment();
  });
  ...
  describe('Comment', function() {
    it('should create an instance of Comment', function() {
      ...
      //var instane = new BimdataApiClient.Comment();
      //expect(instance).to.be.a(BimdataApiClient.Comment);
    });
    ...
    it('should have the property autorizationCommentActions (base name: "autorization_comment_actions")', function() {
      // uncomment below and update the code to test the property autorizationCommentActions
      //var instane = new BimdataApiClient.Comment();
      //expect(instance).to.be();
    });
