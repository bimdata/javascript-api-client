...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new bimdata.ProjectFolderTree();
  });
  ...
  describe('ProjectFolderTree', function() {
    it('should create an instance of ProjectFolderTree', function() {
      // uncomment below and update the code to test ProjectFolderTree
