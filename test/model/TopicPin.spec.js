...
(function(root, factory) {
  ...
  describe('TopicPin', function() {
    it('should create an instance of TopicPin', function() {
      // uncomment below and update the code to test TopicPin
      //var instance = new bimdata.TopicPin();
      //expect(instance).to.be.a(bimdata.TopicPin);
    });
