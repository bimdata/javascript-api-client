...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BimdataApiClient.Rule();
  });
  ...
  describe('Rule', function() {
    it('should create an instance of Rule', function() {
      ...
      //var instane = new BimdataApiClient.Rule();
      //expect(instance).to.be.a(BimdataApiClient.Rule);
    });
    ...
    it('should have the property rulesetId (base name: "ruleset_id")', function() {
