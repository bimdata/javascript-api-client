...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BimdataApiClient.ElementClassificationRelation();
  });
  ...
  describe('ElementClassificationRelation', function() {
    it('should create an instance of ElementClassificationRelation', function() {
      ...
      //var instane = new BimdataApiClient.ElementClassificationRelation();
      //expect(instance).to.be.a(BimdataApiClient.ElementClassificationRelation);
    });
