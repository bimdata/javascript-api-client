...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new bimdata.PinRequest();
  });
  ...
  describe('PinRequest', function() {
    it('should create an instance of PinRequest', function() {
      // uncomment below and update the code to test PinRequest
      //var instance = new bimdata.PinRequest();
      //expect(instance).to.be.a(bimdata.PinRequest);
    });
