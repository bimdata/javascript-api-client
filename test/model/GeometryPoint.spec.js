...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new bimdata.GeometryPoint();
  });
  ...
  describe('GeometryPoint', function() {
    it('should create an instance of GeometryPoint', function() {
      // uncomment below and update the code to test GeometryPoint
      //var instance = new bimdata.GeometryPoint();
      //expect(instance).to.be.a(bimdata.GeometryPoint);
    });
