...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new bimdata.ModelDocument();
  });
  ...
  describe('ModelDocument', function() {
    it('should create an instance of ModelDocument', function() {
      // uncomment below and update the code to test ModelDocument
      //var instance = new bimdata.ModelDocument();
      //expect(instance).to.be.a(bimdata.ModelDocument);
    });
