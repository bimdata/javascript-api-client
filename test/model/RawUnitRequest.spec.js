...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new bimdata.RawUnitRequest();
  });
  ...
  describe('RawUnitRequest', function() {
    it('should create an instance of RawUnitRequest', function() {
      // uncomment below and update the code to test RawUnitRequest
      //var instance = new bimdata.RawUnitRequest();
      //expect(instance).to.be.a(bimdata.RawUnitRequest);
    });
