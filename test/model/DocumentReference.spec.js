...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BimdataApiClient.DocumentReference();
  });
  ...
  describe('DocumentReference', function() {
    it('should create an instance of DocumentReference', function() {
      ...
      //var instane = new BimdataApiClient.DocumentReference();
      //expect(instance).to.be.a(BimdataApiClient.DocumentReference);
    });
