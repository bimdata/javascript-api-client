...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new bimdata.PatchedFullTopicRequest();
  });
  ...
  describe('PatchedFullTopicRequest', function() {
    it('should create an instance of PatchedFullTopicRequest', function() {
      // uncomment below and update the code to test PatchedFullTopicRequest
      //var instane = new bimdata.PatchedFullTopicRequest();
      //expect(instance).to.be.a(bimdata.PatchedFullTopicRequest);
    });
