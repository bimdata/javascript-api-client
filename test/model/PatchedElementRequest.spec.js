...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new bimdata.PatchedElementRequest();
  });
  ...
  describe('PatchedElementRequest', function() {
    it('should create an instance of PatchedElementRequest', function() {
      // uncomment below and update the code to test PatchedElementRequest
      //var instance = new bimdata.PatchedElementRequest();
      //expect(instance).to.be.a(bimdata.PatchedElementRequest);
    });
