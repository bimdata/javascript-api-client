...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new bimdata.FolderWithoutChildren();
  });
  ...
  describe('FolderWithoutChildren', function() {
    it('should create an instance of FolderWithoutChildren', function() {
      // uncomment below and update the code to test FolderWithoutChildren
      //var instance = new bimdata.FolderWithoutChildren();
      //expect(instance).to.be.a(bimdata.FolderWithoutChildren);
    });
