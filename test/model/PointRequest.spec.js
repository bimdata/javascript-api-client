...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new bimdata.PointRequest();
  });
  ...
  describe('PointRequest', function() {
    it('should create an instance of PointRequest', function() {
      // uncomment below and update the code to test PointRequest
      //var instance = new bimdata.PointRequest();
      //expect(instance).to.be.a(bimdata.PointRequest);
    });
