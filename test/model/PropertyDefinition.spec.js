...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BimdataApiClient.PropertyDefinition();
  });
  ...
  describe('PropertyDefinition', function() {
    it('should create an instance of PropertyDefinition', function() {
      ...
      //var instane = new BimdataApiClient.PropertyDefinition();
      //expect(instance).to.be.a(BimdataApiClient.PropertyDefinition);
    });
