...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BimdataApiClient.ElementPropertySetRelation();
  });
  ...
  describe('ElementPropertySetRelation', function() {
    it('should create an instance of ElementPropertySetRelation', function() {
      ...
      //var instane = new BimdataApiClient.ElementPropertySetRelation();
      //expect(instance).to.be.a(BimdataApiClient.ElementPropertySetRelation);
    });
