...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BimdataApiClient.IfcCheckerCheckplan();
  });
  ...
  describe('IfcCheckerCheckplan', function() {
    it('should create an instance of IfcCheckerCheckplan', function() {
      ...
      //var instane = new BimdataApiClient.IfcCheckerCheckplan();
      //expect(instance).to.be.a(BimdataApiClient.IfcCheckerCheckplan);
    });
