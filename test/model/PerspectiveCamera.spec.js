...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BimdataApiClient.PerspectiveCamera();
  });
  ...
  describe('PerspectiveCamera', function() {
    it('should create an instance of PerspectiveCamera', function() {
      ...
      //var instane = new BimdataApiClient.PerspectiveCamera();
      //expect(instance).to.be.a(BimdataApiClient.PerspectiveCamera);
    });
