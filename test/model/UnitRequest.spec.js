...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new bimdata.UnitRequest();
  });
  ...
  describe('UnitRequest', function() {
    it('should create an instance of UnitRequest', function() {
      // uncomment below and update the code to test UnitRequest
      //var instance = new bimdata.UnitRequest();
      //expect(instance).to.be.a(bimdata.UnitRequest);
    });
