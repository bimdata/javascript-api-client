...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BimdataApiClient.IfcApi();
  });
  ...
  describe('IfcApi', function() {
    ...
    describe('createElement_0', function() {
      it('should call createElement_0 successfully', function(done) {
        //uncomment below and update the code to test createElement_0
        //instance.createElement_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('fullUpdateElement_0', function() {
      it('should call fullUpdateElement_0 successfully', function(done) {
        //uncomment below and update the code to test fullUpdateElement_0
        //instance.fullUpdateElement_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('fullUpdateIfcProperty_0', function() {
      it('should call fullUpdateIfcProperty_0 successfully', function(done) {
        //uncomment below and update the code to test fullUpdateIfcProperty_0
        //instance.fullUpdateIfcProperty_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getElement_0', function() {
      it('should call getElement_0 successfully', function(done) {
        //uncomment below and update the code to test getElement_0
        //instance.getElement_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('updateElement_0', function() {
      it('should call updateElement_0 successfully', function(done) {
        //uncomment below and update the code to test updateElement_0
        //instance.updateElement_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('updateIfcProperty_0', function() {
      it('should call updateIfcProperty_0 successfully', function(done) {
        //uncomment below and update the code to test updateIfcProperty_0
        //instance.updateIfcProperty_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
