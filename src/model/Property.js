...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('propertyset_id')) {
        obj['propertyset_id'] = ApiClient.convertToType(data['propertyset_id'], 'Number');
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Number} propertyset_id
   */
  exports.prototype['propertyset_id'] = undefined;
