...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.bimdata.WrappedClass = factory(root.bimdata.ApiClient, root.bimdata.ProjectAction);
  }
  ...
  /**
   * The WrappedClass model module.
   * @module model/WrappedClass
   * @version 1.0.13
   */

  /**
   * Constructs a new <code>WrappedClass</code>.
   * @alias module:model/WrappedClass
   * @class
   * @param name {String} 
   */
  ...
  /**
   * Constructs a <code>WrappedClass</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/WrappedClass} obj Optional instance to populate.
   * @return {module:model/WrappedClass} The populated <code>WrappedClass</code> instance.
   */
