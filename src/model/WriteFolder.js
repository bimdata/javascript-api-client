...
class WriteFolder {
     ...
     */
    constructor(createdAt, id, type, userPermission, updatedAt, name, createdBy, groupsPermissions, nature) { 
        
        WriteFolder.initialize(this, createdAt, id, type, userPermission, updatedAt, name, createdBy, groupsPermissions, nature);
    }
     ...
     */
    static initialize(obj, createdAt, id, type, userPermission, updatedAt, name, createdBy, groupsPermissions, nature) { 
