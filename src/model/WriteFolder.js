...
class WriteFolder {
     ...
     */
    constructor(type, name, id, groupsPermissions, createdAt, updatedAt, nature, createdBy, userPermission) { 
        
        WriteFolder.initialize(this, type, name, id, groupsPermissions, createdAt, updatedAt, nature, createdBy, userPermission);
    }
     ...
     */
    static initialize(obj, type, name, id, groupsPermissions, createdAt, updatedAt, nature, createdBy, userPermission) { 
        obj['type'] = type;
        obj['name'] = name;
        obj['id'] = id;
