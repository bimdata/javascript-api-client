...
class WriteFolder {
     ...
     */
    constructor(userPermission, groupsPermissions, id, name, type, createdBy, nature, updatedAt, createdAt) { 
        
        WriteFolder.initialize(this, userPermission, groupsPermissions, id, name, type, createdBy, nature, updatedAt, createdAt);
    }
     ...
     */
    static initialize(obj, userPermission, groupsPermissions, id, name, type, createdBy, nature, updatedAt, createdAt) { 
