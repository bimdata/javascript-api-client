...
class WriteFolder {
     ...
     */
    constructor(groupsPermissions, createdAt, name, updatedAt, nature, createdBy, id, userPermission, type) { 
        
        WriteFolder.initialize(this, groupsPermissions, createdAt, name, updatedAt, nature, createdBy, id, userPermission, type);
    }
     ...
     */
    static initialize(obj, groupsPermissions, createdAt, name, updatedAt, nature, createdBy, id, userPermission, type) { 
