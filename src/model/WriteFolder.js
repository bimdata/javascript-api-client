...
class WriteFolder {
     ...
     */
    constructor(createdAt, userPermission, name, groupsPermissions, id, type, nature, createdBy, updatedAt) { 
        
        WriteFolder.initialize(this, createdAt, userPermission, name, groupsPermissions, id, type, nature, createdBy, updatedAt);
    }
     ...
     */
    static initialize(obj, createdAt, userPermission, name, groupsPermissions, id, type, nature, createdBy, updatedAt) { 
