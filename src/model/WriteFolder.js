...
class WriteFolder {
     ...
     */
    constructor(nature, id, name, type, createdBy, userPermission, groupsPermissions, updatedAt, createdAt) { 
        
        WriteFolder.initialize(this, nature, id, name, type, createdBy, userPermission, groupsPermissions, updatedAt, createdAt);
    }
     ...
     */
    static initialize(obj, nature, id, name, type, createdBy, userPermission, groupsPermissions, updatedAt, createdAt) { 
        obj['nature'] = nature;
        obj['id'] = id;
        obj['name'] = name;
        obj['type'] = type;
