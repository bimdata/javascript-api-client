...
class WriteFolder {
     ...
     */
    constructor(nature, name, updatedAt, id, createdBy, createdAt, groupsPermissions, userPermission, type) { 
        
        WriteFolder.initialize(this, nature, name, updatedAt, id, createdBy, createdAt, groupsPermissions, userPermission, type);
    }
     ...
     */
    static initialize(obj, nature, name, updatedAt, id, createdBy, createdAt, groupsPermissions, userPermission, type) { 
        obj['nature'] = nature;
        obj['name'] = name;
