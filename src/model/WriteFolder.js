...
class WriteFolder {
     ...
     */
    constructor(nature, updatedAt, groupsPermissions, createdAt, createdBy, userPermission, name, id, type) { 
        
        WriteFolder.initialize(this, nature, updatedAt, groupsPermissions, createdAt, createdBy, userPermission, name, id, type);
    }
     ...
     */
    static initialize(obj, nature, updatedAt, groupsPermissions, createdAt, createdBy, userPermission, name, id, type) { 
        obj['nature'] = nature;
