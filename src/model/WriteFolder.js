...
class WriteFolder {
     ...
     */
    constructor(updatedAt, id, userPermission, createdBy, name, createdAt, groupsPermissions, nature, type) { 
        
        WriteFolder.initialize(this, updatedAt, id, userPermission, createdBy, name, createdAt, groupsPermissions, nature, type);
    }
     ...
     */
    static initialize(obj, updatedAt, id, userPermission, createdBy, name, createdAt, groupsPermissions, nature, type) { 
