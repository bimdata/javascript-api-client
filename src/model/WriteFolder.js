...
class WriteFolder {
     ...
     */
    constructor(updatedAt, groupsPermissions, nature, name, id, type, userPermission, createdAt, createdBy) { 
        
        WriteFolder.initialize(this, updatedAt, groupsPermissions, nature, name, id, type, userPermission, createdAt, createdBy);
    }
     ...
     */
    static initialize(obj, updatedAt, groupsPermissions, nature, name, id, type, userPermission, createdAt, createdBy) { 
