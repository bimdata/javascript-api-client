...
class WriteFolder {
     ...
     */
    constructor(nature, updatedAt, createdBy, name, groupsPermissions, userPermission, id, type, createdAt) { 
        
        WriteFolder.initialize(this, nature, updatedAt, createdBy, name, groupsPermissions, userPermission, id, type, createdAt);
    }
     ...
     */
    static initialize(obj, nature, updatedAt, createdBy, name, groupsPermissions, userPermission, id, type, createdAt) { 
        obj['nature'] = nature;
