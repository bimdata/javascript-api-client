...
class WriteFolder {
     ...
     */
    constructor(updatedAt, id, type, createdAt, userPermission, nature, groupsPermissions, name, createdBy) { 
        
        WriteFolder.initialize(this, updatedAt, id, type, createdAt, userPermission, nature, groupsPermissions, name, createdBy);
    }
     ...
     */
    static initialize(obj, updatedAt, id, type, createdAt, userPermission, nature, groupsPermissions, name, createdBy) { 
