...
class WriteFolder {
     ...
     */
    constructor(type, createdAt, createdBy, id, name, updatedAt, groupsPermissions, userPermission, nature) { 
        
        WriteFolder.initialize(this, type, createdAt, createdBy, id, name, updatedAt, groupsPermissions, userPermission, nature);
    }
     ...
     */
    static initialize(obj, type, createdAt, createdBy, id, name, updatedAt, groupsPermissions, userPermission, nature) { 
        obj['type'] = type;
