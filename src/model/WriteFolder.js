...
class WriteFolder {
     ...
     */
    constructor(createdAt, nature, name, type, id, updatedAt, groupsPermissions, createdBy, userPermission) { 
        
        WriteFolder.initialize(this, createdAt, nature, name, type, id, updatedAt, groupsPermissions, createdBy, userPermission);
    }
     ...
     */
    static initialize(obj, createdAt, nature, name, type, id, updatedAt, groupsPermissions, createdBy, userPermission) { 
