...
import ManagedByEnum from './ManagedByEnum';
...
class Size {
     ...
     * @param managedBy {module:model/ManagedByEnum} 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('managed_by')) {
                obj['managed_by'] = ManagedByEnum.constructFromObject(data['managed_by']);
            }
            if (data.hasOwnProperty('role')) {
                obj['role'] = CloudRoleEnum.constructFromObject(data['role']);
            }
...
/**
 * @member {module:model/ManagedByEnum} managed_by
 */
