...
class Project {
     ...
     * @param cloud {module:model/Cloud} 
     * @param createdAt {Date} Creation date
     * @param updatedAt {Date} Date of the last update
     * @param rootFolderId {Number} 
     */
    constructor(id, name, cloud, createdAt, updatedAt, rootFolderId) { 
        
        Project.initialize(this, id, name, cloud, createdAt, updatedAt, rootFolderId);
    }
     ...
     */
    static initialize(obj, id, name, cloud, createdAt, updatedAt, rootFolderId) { 
        obj['id'] = id;
        obj['name'] = name;
        obj['cloud'] = cloud;
