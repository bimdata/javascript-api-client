...
/**
 * The ModelFiles model module.
 * @module model/ModelFiles
 * @version 0.0.0
 */
class ModelFiles {
    /**
     * Constructs a new <code>ModelFiles</code>.
     * @alias module:model/ModelFiles
     */
    constructor() { 
        
        ModelFiles.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ModelFiles</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ModelFiles} obj Optional instance to populate.
     * @return {module:model/ModelFiles} The populated <code>ModelFiles</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ModelFiles();
 ...
 */
ModelFiles.prototype['structure_file'] = undefined;

/**
 * @member {String} systems_file
 */
ModelFiles.prototype['systems_file'] = undefined;

/**
 * @member {String} map_file
 */
ModelFiles.prototype['map_file'] = undefined;
