...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/IfcCreator', 'model/IfcDocument', 'model/IfcProject', 'model/Zone'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./IfcCreator'), require('./IfcDocument'), require('./IfcProject'), require('./Zone'));
  } else {
    // Browser globals (root is window)
    if (!root.bimdata) {
      root.bimdata = {};
    }
    root.bimdata.Ifc = factory(root.bimdata.ApiClient, root.bimdata.IfcCreator, root.bimdata.IfcDocument, root.bimdata.IfcProject, root.bimdata.Zone);
  }
}(this, function(ApiClient, IfcCreator, IfcDocument, IfcProject, Zone) {
  'use strict';
