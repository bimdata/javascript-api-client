...
import VisaValidationStatusEnum from './VisaValidationStatusEnum';
...
class VisaValidation {
     ...
     * @param status {module:model/VisaValidationStatusEnum} 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('status')) {
                obj['status'] = ApiClient.convertToType(data['status'], VisaValidationStatusEnum);
            }
...
/**
 * @member {module:model/VisaValidationStatusEnum} status
 */
