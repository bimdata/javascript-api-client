...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
    this.createRawElementsWithHttpInfo = function(cloudPk, ifcPk, projectPk, element) {
      var postBody = element;
      ...
      // verify the required parameter 'element' is set
      if (element === undefined || element === null) {
        throw new Error("Missing the required parameter 'element' when calling createRawElements");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}
     */
    this.createRawElements = function(cloudPk, ifcPk, projectPk, element) {
      return this.createRawElementsWithHttpInfo(cloudPk, ifcPk, projectPk, element)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
