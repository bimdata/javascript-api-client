...
export default class CollaborationApi {
    ...
    */
     ...
     * @param {module:model/ModelSourceEnum} opts.modelSource Define the model.source field if the upload is a Model (IFC, PDF, DWG...)
     * @param {module:model/ModelSourceEnum} opts.ifcSource DEPRECATED: Use 'model_source' instead. Define the model.source field if the upload is a Model (IFC, PDF, DWG...)
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
