...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     */
    this.createProjectUserWithHttpInfo = function(cloudPk, projectPk, fosUserWrite) {
      ...
      if (fosUserWrite === undefined || fosUserWrite === null) {
        throw new Error("Missing the required parameter 'fosUserWrite' when calling createProjectUser");
      }
     ...
     */
    this.createProjectUser = function(cloudPk, projectPk, fosUserWrite) {
      return this.createProjectUserWithHttpInfo(cloudPk, projectPk, fosUserWrite)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    /**
     * @param {String} cloudPk 
     * @param {Number} id2 A unique integer value identifying this document.
     * @param {String} projectPk 
     * @param {String} name 
     * @param {Object} opts Optional parameters
     * @param {Number} opts.id 
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/Document} and HTTP response
     */
    this.fullUpdateDocumentWithHttpInfo = function(cloudPk, id2, projectPk, name, opts) {
      opts = opts || {};
      var postBody = null;
      ...
      if (id2 === undefined || id2 === null) {
        throw new Error("Missing the required parameter 'id2' when calling fullUpdateDocument");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/Document}
     */
    this.fullUpdateDocument = function(cloudPk, id2, projectPk, name, opts) {
      return this.fullUpdateDocumentWithHttpInfo(cloudPk, id2, projectPk, name, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/FosUserWrite} and HTTP response
     */
    this.fullUpdateProjectUserWithHttpInfo = function(cloudPk, id, projectPk, fosUserWrite) {
      var postBody = fosUserWrite;
      ...
      // verify the required parameter 'fosUserWrite' is set
      if (fosUserWrite === undefined || fosUserWrite === null) {
        throw new Error("Missing the required parameter 'fosUserWrite' when calling fullUpdateProjectUser");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/FosUserWrite}
     */
    this.fullUpdateProjectUser = function(cloudPk, id, projectPk, fosUserWrite) {
      return this.fullUpdateProjectUserWithHttpInfo(cloudPk, id, projectPk, fosUserWrite)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/FosUserWrite} and HTTP response
     */
    this.updateProjectUserWithHttpInfo = function(cloudPk, id, projectPk, fosUserWrite) {
      var postBody = fosUserWrite;
      ...
      // verify the required parameter 'fosUserWrite' is set
      if (fosUserWrite === undefined || fosUserWrite === null) {
        throw new Error("Missing the required parameter 'fosUserWrite' when calling updateProjectUser");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/FosUserWrite}
     */
    this.updateProjectUser = function(cloudPk, id, projectPk, fosUserWrite) {
      return this.updateProjectUserWithHttpInfo(cloudPk, id, projectPk, fosUserWrite)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
