...
*bimdata.ModelApi* | [**bulkDeleteIfcClassifications**](docs/ModelApi.md#bulkDeleteIfcClassifications) | **DELETE** /cloud/{cloud_pk}/project/{project_pk}/model/{model_pk}/classification/list_destroy | Remove all classifications from model&#39;s elements
*bimdata.ModelApi* | [**bulkDeleteIfcProperties**](docs/ModelApi.md#bulkDeleteIfcProperties) | **DELETE** /cloud/{cloud_pk}/project/{project_pk}/model/{model_pk}/property/bulk_destroy | Delete many Property of a model
*bimdata.ModelApi* | [**bulkDeleteIfcPropertyDefinitions**](docs/ModelApi.md#bulkDeleteIfcPropertyDefinitions) | **DELETE** /cloud/{cloud_pk}/project/{project_pk}/model/{model_pk}/propertydefinition/bulk_destroy | Delete many PropertyDefinitions of a model
*bimdata.ModelApi* | [**bulkDeleteIfcUnits**](docs/ModelApi.md#bulkDeleteIfcUnits) | **DELETE** /cloud/{cloud_pk}/project/{project_pk}/model/{model_pk}/unit/bulk_destroy | Delete many Units of a model
...
*bimdata.ModelApi* | [**bulkFullUpdateIfcProperty**](docs/ModelApi.md#bulkFullUpdateIfcProperty) | **PATCH** /cloud/{cloud_pk}/project/{project_pk}/model/{model_pk}/property/bulk_update | Update some fields of many properties of a model
...
*bimdata.ModelApi* | [**bulkUpdateIfcProperty**](docs/ModelApi.md#bulkUpdateIfcProperty) | **PUT** /cloud/{cloud_pk}/project/{project_pk}/model/{model_pk}/property/bulk_update | Update all fields of many properties of a model
...
*bimdata.ModelApi* | [**createIfcPropertyDefinition**](docs/ModelApi.md#createIfcPropertyDefinition) | **POST** /cloud/{cloud_pk}/project/{project_pk}/model/{model_pk}/propertydefinition | Create a PropertyDefinition on the model
*bimdata.ModelApi* | [**createIfcUnit**](docs/ModelApi.md#createIfcUnit) | **POST** /cloud/{cloud_pk}/project/{project_pk}/model/{model_pk}/unit | Create a Unit on a model
...
*bimdata.ModelApi* | [**deleteIfcProperty**](docs/ModelApi.md#deleteIfcProperty) | **DELETE** /cloud/{cloud_pk}/project/{project_pk}/model/{model_pk}/property/{id} | Delete a Property of a model
*bimdata.ModelApi* | [**deleteIfcPropertyDefinition**](docs/ModelApi.md#deleteIfcPropertyDefinition) | **DELETE** /cloud/{cloud_pk}/project/{project_pk}/model/{model_pk}/propertydefinition/{id} | Delete a PropertyDefinitions of a model
*bimdata.ModelApi* | [**deleteIfcUnit**](docs/ModelApi.md#deleteIfcUnit) | **DELETE** /cloud/{cloud_pk}/project/{project_pk}/model/{model_pk}/unit/{id} | Delete a Unit of a model
...
*bimdata.ModelApi* | [**getIfcClassifications**](docs/ModelApi.md#getIfcClassifications) | **GET** /cloud/{cloud_pk}/project/{project_pk}/model/{model_pk}/classification | Retrieve all classifications in a model
*bimdata.ModelApi* | [**getIfcMaterial**](docs/ModelApi.md#getIfcMaterial) | **GET** /cloud/{cloud_pk}/project/{project_pk}/model/{model_pk}/material/{id} | Retrieve a material of a model
*bimdata.ModelApi* | [**getIfcMaterials**](docs/ModelApi.md#getIfcMaterials) | **GET** /cloud/{cloud_pk}/project/{project_pk}/model/{model_pk}/material | Retrieve all materials of a model
*bimdata.ModelApi* | [**getIfcProperties**](docs/ModelApi.md#getIfcProperties) | **GET** /cloud/{cloud_pk}/project/{project_pk}/model/{model_pk}/property | Retrieve all Properties of a model
*bimdata.ModelApi* | [**getIfcProperty**](docs/ModelApi.md#getIfcProperty) | **GET** /cloud/{cloud_pk}/project/{project_pk}/model/{model_pk}/property/{id} | Retrieve a Property of a model
*bimdata.ModelApi* | [**getIfcPropertyDefinition**](docs/ModelApi.md#getIfcPropertyDefinition) | **GET** /cloud/{cloud_pk}/project/{project_pk}/model/{model_pk}/propertydefinition/{id} | Retrieve a PropertyDefinition of a model
*bimdata.ModelApi* | [**getIfcPropertyDefinitions**](docs/ModelApi.md#getIfcPropertyDefinitions) | **GET** /cloud/{cloud_pk}/project/{project_pk}/model/{model_pk}/propertydefinition | Retrieve all PropertyDefinitions of a model
*bimdata.ModelApi* | [**getIfcUnit**](docs/ModelApi.md#getIfcUnit) | **GET** /cloud/{cloud_pk}/project/{project_pk}/model/{model_pk}/unit/{id} | Retrieve a Unit of a model
*bimdata.ModelApi* | [**getIfcUnits**](docs/ModelApi.md#getIfcUnits) | **GET** /cloud/{cloud_pk}/project/{project_pk}/model/{model_pk}/unit | Retrieve all Units of a model
...
*bimdata.ModelApi* | [**updateIfcProperty**](docs/ModelApi.md#updateIfcProperty) | **PATCH** /cloud/{cloud_pk}/project/{project_pk}/model/{model_pk}/property/{id} | Update some fields of a Property
*bimdata.ModelApi* | [**updateIfcPropertyDefinition**](docs/ModelApi.md#updateIfcPropertyDefinition) | **PATCH** /cloud/{cloud_pk}/project/{project_pk}/model/{model_pk}/propertydefinition/{id} | Update some fields of many PropertyDefinitions of a model
*bimdata.ModelApi* | [**updateIfcUnit**](docs/ModelApi.md#updateIfcUnit) | **PATCH** /cloud/{cloud_pk}/project/{project_pk}/model/{model_pk}/unit/{id} | Update some fields of a Unit of a model
